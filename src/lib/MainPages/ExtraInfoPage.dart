...
class _CustomExtraInfoFormState extends State<CustomExtraInfoForm> {
  ...
  Future<void> _saveExtraInfo() async {
    ...
    if (!_formKey.currentState!.validate()) {
      _showErrorDialog("Invalid data!", "Please fill in all the fields.");
    ...
    if (_moreAboutYourselfController.text.trim().length > 200) {
      _showErrorDialog("Invalid Description!",
          "More about yourself cannot be more than 200 characters.");
      return;
    }
        ...
        images[id] = DismissibleImageCard(
            ...
            onRemove: () {
              ...
              _formKey.currentState!
                  .validate(); // Validate the form after the image is selected
            });
      }
      _formKey.currentState!
          .validate(); // Validate the form after the image is selected
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  counterText: _nameController.text.trim().length == 0
                      ? null
                      : '${_nameController.text.trim().length}/30 characters',
                  counterStyle: TextStyle(
                    color: _nameController.text.trim().length > 30
                        ? Colors.red
                        : Colors.black,
                    fontSize: 14,
                  ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: Theme.of(context).bottomAppBarTheme.color,
                  floatingLabelBehavior: FloatingLabelBehavior.never,
                  counterText: _moreAboutYourselfController.text
                              .trim()
                              .length ==
                          0
                      ? null
                      : '${_moreAboutYourselfController.text.trim().length}/200 characters',
                  counterStyle: TextStyle(
                    color: _moreAboutYourselfController.text.trim().length > 200
                        ? Colors.red
                        : Colors.black,
                    fontSize: 14,
                  ),
